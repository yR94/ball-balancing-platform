...
/////// global veribal //////////////
const int standByH=20;
const int  X1 = A0, Y1 = A1, X2 = A2, Y2 = A3; //touch screen wires
int Xmeas[3] = {0};
int Ymeas[3] = {0};
...
void setup() {
 Serial.begin(9600); 
    ...
    servo2.attach(10);
    servo3.attach(11);
    servo1.write(standByH);
    servo2.write(standByH);
    servo3.write(standByH);
    delay(500);
    ///////////////////////////////////////////////////////////
...
t = micros();
 ...
 touchFlag++;
 if(touchFlag>10)   hight(standByH);
}
